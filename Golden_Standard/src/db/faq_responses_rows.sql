INSERT INTO "public"."faq_responses" ("id", "question", "answer", "tag_id") VALUES ('1', 'immatrikulationsbescheinigung', '🎓 To receive your Immatrikulationsbescheinigung (Enrollment Certificate), follow these steps:
...
📥 You will receive your certificate in digital format within approximately 2–3 business days.', '1'), ('2', 'laundry', '🧺 Each college block at Constructor University has a dedicated laundry room located in the basement.
...
📱 Download the Airwallet app, create an account, and follow the instructions posted in your dorm’s laundry area.', '3'), ('3', 'residence permit', '🛂 **Applying for a Residence Permit in Bremen**
...
📍 **Migration Office Bremen**: [Google Maps Link](https://goo.gl/maps/WezXD1ZyEF5M2rU57)', '2'), ('4', 'address change', '🏠 **Changing Your Address in Bremen**
...
- Stresemannstraße: Stresemannstraße 48, 28207 Bremen', '2'), ('5', 'emergency contacts', '🚨 **Emergency Contacts at Constructor University**
...
ℹ️ Please use these numbers responsibly and only in case of real emergencies.', '5'), ('6', 'driving license conversion', '🚗 **Converting a Foreign Driving License in Bremen**
...
📧 Email: fuehrerschein@buergeramt.bremen.de', '1'), ('7', 'semester ticket', '🚆 Constructor University has joined the **Deutschlandsemester-Ticket** system starting from Spring 2025. This allows you to travel *throughout Germany* using:
...
🪪 Please make sure to always carry a valid **photo ID** (e.g., passport or residence card) with your ticket while traveling, as it may be required during checks.', '4'), ('8', 'Postal code', 'The Univeristy's Postal code is 28759', '2');